...
import com.kn.appwallpaper.adapter.SearchedImagesAdapter
...
class SearchFragment : Fragment(), SearchedImagesAdapter.OnItemClickedListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchedImagesAdapter = SearchedImagesAdapter(arrayListOf(), requireContext(), this)
        search_view.adapter = searchedImagesAdapter
        search_view.layoutManager = GridLayoutManager(requireContext(), NUMBER_OF_COLUMNS)
